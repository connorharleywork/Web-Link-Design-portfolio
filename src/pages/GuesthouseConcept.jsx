        ...
        <div className="mx-auto grid w-full max-w-7xl items-end gap-8 lg:grid-cols-[1.05fr_.7fr]">
          <Reveal>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <button onClick={() => goToEnquiry('Guesthouse / Airbnb Website — availability enquiry demo')} className="premium-button rounded-full bg-[#d8b56d] px-7 py-4 font-bold text-[#071521]">Check Availability</button>
          ...
          <Reveal delay={0.08} className="rounded-[2rem] border border-white/15 bg-[#fbf4e7]/95 p-5 text-[#071521] shadow-2xl shadow-black/30">
            ...
            <button onClick={() => goToEnquiry('Guesthouse / Airbnb Website — booking panel search demo')} className="mt-5 inline-flex min-h-[52px] w-full items-center justify-center gap-2 rounded-full bg-[#071521] px-5 font-bold text-white"><Search size={18} /> Search Stay</button>
