    ...
    <section id="home" className="mesh relative overflow-hidden px-4 pb-20 pt-32 sm:px-5 md:pt-40 lg:min-h-screen lg:pb-28">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[1.02fr_.98fr] lg:gap-14">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .75 }}>
          ...
          <h1 className="max-w-4xl text-4xl font-semibold leading-[1.02] tracking-[-.04em] text-[#fff6dd] sm:text-5xl md:text-7xl lg:text-[5.25rem]">Websites that make your business look <span className="gold-text">impossible to ignore.</span></h1>
          <p className="mt-6 max-w-2xl text-base leading-7 text-[#c9c0ad] sm:text-lg sm:leading-8">Premium, conversion-focused websites for businesses that want to look established, earn trust quickly, and turn visitors into quality enquiries.</p>
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:gap-4">
            <a href="#options" className="min-h-[52px] rounded-full bg-[#d8b56d] px-7 py-4 text-center font-semibold text-[#161109] shadow-[0_0_42px_rgba(216,181,109,.28)] transition hover:-translate-y-0.5 hover:shadow-[0_0_60px_rgba(216,181,109,.36)]">Explore Website Options</a>
        ...
        <motion.div initial={{ opacity: 0, scale: .94 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: .8, delay: .15 }} className="relative mx-auto w-full max-w-[620px]">
          ...
          <div className="glass relative overflow-hidden rounded-[1.75rem] p-3 sm:rounded-[2.25rem] sm:p-4">
