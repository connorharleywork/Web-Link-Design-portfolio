      ...
      <div className="mx-auto grid max-w-7xl items-center gap-8 lg:grid-cols-[1.05fr_.95fr] lg:gap-12">
        <div>
          <SectionHeader
            ...
            text="Web Link Designs is a Cape Town-based web design studio helping businesses look professional online. The focus is simple: create websites that feel refined, work beautifully on mobile, explain the business clearly and make it easy for visitors to enquire."
          />
