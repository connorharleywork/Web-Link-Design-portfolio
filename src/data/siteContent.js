...
export const navLinks = [
  ['Home', 'home'], ['Concepts', 'concepts'], ['About', 'about'], ['Services', 'services'], ['Packages', 'packages'], ['Process', 'process'], ['Contact', 'contact'],
];
...
export const capeLegalConcept = {
  ...
  advisors: [
    { name: 'Sarah van der Merwe', role: 'Principal Legal Advisor', focus: 'Contracts, property, business advisory', bio: 'Sarah is positioned as the calm lead advisor for complex decisions and document-heavy matters.', credentials: 'Example credentials · illustrative profile', image: 'https://images.unsplash.com/photo-1573497019418-b400bb3ab074?auto=format&fit=crop&w=900&q=82', alt: 'Professional woman in a business portrait for principal advisor' },
    ...
    { name: 'Aisha Khan', role: 'Client Advisory Coordinator', focus: 'Intake, document preparation, client communication', bio: 'Aisha coordinates intake, documents, communication and preparation so clients feel informed.', credentials: 'Example credentials · illustrative profile', image: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?auto=format&fit=crop&w=900&q=82', alt: 'Professional woman in office portrait for client advisory coordinator' },
  ],
